#!/bin/bash
# Serial console on Modem 2 (SCC) at 38400 baud (fractal: picocom /dev/atari-tt 38400) — scc.xdd refuses 57600 (termios and TIOCOBAUD both return 38400 as nearest, TT 2026-09-13).
