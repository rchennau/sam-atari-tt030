 ...
 * Booted raw by shabench exactly as xserv is (see ../x25519bench/xserv.c for the start-up story).
 ...
 * Build: see ../x25519bench/BUILD.txt, with shaserv.c + sha256.c and shaserv.lnk.
 */
#include <channel.h>
#include "sha256.h"
