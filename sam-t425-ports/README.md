...
| The T425 is part of the TT030 | No. It is the ATW800/2 expansion card: a second 32-bit CPU with its own ~5 MB (measured usable: 4.94 MB) reached over a link of ~459 KB/s one way. Moving data costs time, so offloading wins only where the work per byte is high. |
